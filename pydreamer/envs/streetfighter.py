...
class Streetfighter(retro.RetroEnv):

    LOCK = threading.Lock()

    def __init__(self, name, game, action_repeat=4, size=(64, 64), grayscale=False, noops=30, life_done=False,
                 sticky_actions=True, all_actions=True):
        super().__init__(game)
